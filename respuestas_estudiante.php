...
<body id="cuerpo"  style="background-image: url(images/bg7.jpg)">
	...
	?>
		...
		<header class="color-output" style="background-color:#00d6cb <?php ;
															} ?>;" <?php
...
<p class="text2" style="text-align:left;"> <a style= "color:#ff0000">(*)</a> <a style= "color:#454545" >Campos obligatorios</a> </p><br><br>
	<a href="index3.php"><button style = "position:absolute; left:140px; top:90px;" class="btn btn-sm btn-danger">Regresar</button></a>
	<br><br><br>
	<form action="" method="post" enctype="multipart/form-data" id="formulario">
		<div class="container">
			...
			<form id="mainForm" method="POST" action="">
				<!-- Agregar input para el nombre del usuario -->
				
			
					
				<div class="row card">
					<div class="col-3">
						<label class="lblPreguntaText">
							Ingrese su nombre
						</label>
						<input type="hidden">
					</div>
					<input type="hidden" class="txt" value="text">
					<div class="col-9">
						<input type="text" id="txtNombre" name="nombreAlumno" required="" class="form-control">
					</div>
				</div>
				<?php
				$cont = 0;
					...
					<div class="col-9">
						<div class="group">
							<div class="col-6 text-center">
								<input style="position:absolute; center;" type="submit" id="guardarBtn" name="guardarBtn" class="btn btn-sm btn-success" value="Guardar">
							</div>
							<div class="col-6 text-center">
