            ...
            if (inputedMindMapName) {
                for (let i = 0; i < currentUser.mindmaps.length; i++) {
                    ...
                    if (savedMindMapName === inputedMindMapName) {
                        ...
                        /* Recorrer todas las KeyWords del MindMap */
                        for(let j = 0; j < this.keywords.length; j++){
                            /* Colocar elementos de texto en el contenedor */
                            var contenedor = document.querySelector(".contenedor");
                            /* Creamos el elemento */
                            var texto = document.createElement("p");
                            texto.classList.add("KeyWord" + j);
                            texto.textContent = this.keywords[j].text;
                            texto.draggable = "true";
                            /* Asignamos el resultado obtenido como hijo del contenedor */
                            contenedor.appendChild(texto);    
                            /* Limpiamos el texto de cada elemento */
                            this.keywords[j].text = "";
                        }
                    }
                }
                console.log(this);
...
//========================== OPEN mind map seetings navbar event listeners: ==========
