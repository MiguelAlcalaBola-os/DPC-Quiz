...
<head>
	...
	<style type="text/css">
		...
		.card { padding: 25px;  box-shadow: 15px 8px 15px rgba(0, 0, 0, .1); margin:20px; }
		.red { color: red; }
	</style>
</head>
<body>
				...
				<ul>
					<?php
						...
						while ($row = mysqli_fetch_array($query)) {
					    	echo '<li>
							<a href="../respuestas_estudiante.php?n='.$row['cuestionario_id'].'">'.$row['cuestionario_nombre']. '</a>' .
							'&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;'. 
							'<a href="../respuestas_docente.php?n=' . $row['cuestionario_id'] . '">'.'</a>' .
