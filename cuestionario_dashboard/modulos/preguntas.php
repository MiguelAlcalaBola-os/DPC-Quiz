...
<body>
	<div class="container-fluid">
		<div class="card">
			...
			<div class="row">
				<div class="col-3">
					<label form="id_cuestionario">Seleccione la pregunta a la cual desea agregar Opciones Múltiples </label>
				</div>
				<div class="col-9">
		...
		<div class="card">
			...
			<form method="post" id="mainForm">
				<div class="row">
					<div class="col-3">
						<label form="id_cuestionario">Seleccione el cuestionario donde se guardaran las preguntas</label>
					</div>
					<div class="col-9">
				...
				<div class="row">
					<div class="col-3">
						<label form="">Puntuación de pregunta</label>
					</div>
					<div class="col-9">
